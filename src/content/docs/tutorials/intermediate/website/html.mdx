...
<Aside type="note" title="Meta Tags Do a Lot More">
  ...
  here. That rabbit hole is outside the scope of this tutorial, but **MDN's meta element reference** [^4]
...
[^1]: In [*Harry Potter and the Philosopher's Stone* (2001)](https://www.imdb.com/title/tt0241527/),
      a flustered Harry tries to travel by Floo Powder and says "Diagon Alley" — but it
      comes out as "diagonally," landing him in the wrong shop entirely. Debugging bad
      copy-paste code feels exactly like this.
[^2]: See the [IANA Language Subtag Registry](https://www.iana.org/assignments/language-subtag-registry)
for the full list of two-letter codes
[^3]: See the friendlier [W3C language tag lookup tool](https://r12a.github.io/app-subtags/) if you want to
search by language name instead of memorizing abbreviations.
[^4]: [MDN's meta element reference](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta)
